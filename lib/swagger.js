...
const swaggerSpec = {
  ...
  paths: {
    ...
    '/api/cart/checkout': {
      post: {
        tags: ['Cart'],
        summary: 'Checkout the active cart (changes status to checked_out)',
        description: 'Converts the current active cart into a sales order record by updating its status. This action should be followed by generating a PDF Sales Order on the client side.',
        security: [{ bearerAuth: [] }],
        responses: { 
          200: { 
              ...
              'application/json': {
                schema: {
                  ...
                  properties: {
                    ...
                    cartId: { type: 'string', example: '12345' }
                  }
                }
              }
            }
          ...
          400: { 
            description: 'Bad Request - No active cart, cart is empty, or missing required fields' 
          },
          401: { 
